...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{ asset($admin_source . '/plugins/iCheck/square/blue.css') }}">
...
<div class="login-box">
    <div class="login-logo">
        <a href="#"><b>Панель</b>Администратора</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        ...
        <form action="{{ url('admin/login') }}" method="post">
            ...
            <div class="form-group has-feedback">
                <input type="email" class="form-control" name="email" value="<?= (isset($_SESSION['user']['remember']) && $_SESSION['user']['remember']) ? $_SESSION['user']['email'] : ''?>" placeholder="Эл. почта">
                <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <input type="password" class="form-control" name="password" value="<?= (isset($_SESSION['user']['remember']) && $_SESSION['user']['remember']) ? $_SESSION['user']['password'] : ''?>" placeholder="Пароль">
            ...
            <div class="row">
                ...
                <!-- /.col -->
                <div class="col-xs-4">
                    <button type="submit" name="sub" class="btn btn-primary btn-block btn-flat">Войти</button>
                </div>
                <!-- /.col -->
            </div>
        </form>
...
<!-- iCheck -->
<script src="{{ asset($admin_source . '/plugins/iCheck/icheck.min.js') }}"></script>
<script>
    $(function () {
        $('input').iCheck({
