...
$('#add-wish-list').click(function(){
    ...
    if($(this).attr('data-type') == 'added'){
        document.location = host + '/profile/desires';
        return;
    }
